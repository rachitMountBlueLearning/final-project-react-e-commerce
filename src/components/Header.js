		...
		return (
			<section className="header-section">
				...
				<nav className="navbar">
					...
					<Link to="/contact" className="header-nav-link"><i className="fas fa-mobile-alt"></i>Contact</Link>
				</nav>
				<div className="header-buttons-section">
					<Link to="/cart" className="button-cart"><i class="fas fa-shopping-cart"></i> My Cart</Link>
